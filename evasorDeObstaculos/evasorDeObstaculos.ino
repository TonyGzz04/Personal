...
void loop() {
    if (miBT.available()){      //si el celular manda un mensaje:
      ...
      if (dato=='e'){       //si dato es igual a 'e':       comienza if modo evasor
        x=1;
        while (x==1){        //mientras x=1:       comienza while modo evasor
        ...
        }   //termina while modo evaasor
      }     //termina if modo evasor
